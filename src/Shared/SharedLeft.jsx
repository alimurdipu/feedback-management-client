...
const SharedLeft = () => {
  return (
    <div className="w-60 min-h-screen bg-[#F1F1F1]">
      <div className="space-y-10">
      <div className="w-44 m-auto flex gap-2 text-center justify-start items-center mt-7">
        <div className="">
      ...
      <div className="mt-14 space-y-4">
        ...
        {
          navData.map(data=><div key={data.id} className="w-60 m-auto space-y-1">
             <NavLink to={data.pathname}  className={({ isActive }) => isActive ? "flex items-center gap-1 w-60 py-1.5 px-5 font-medium text-start  text-blue-700 border-l-4 border-blue-700" : "flex items-center gap-1 w-60 py-1.5 px-5 font-medium text-start border-l-4 border-white "}>
