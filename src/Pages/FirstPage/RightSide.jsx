  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="md:flex gap-4 h-[calc(100vh-245px)]  overflow-hidden overflow-y-scroll scrollbar-hide">
              ...
              <div className="md:w-96 m-auto bg-opacity-20 rounded-md bg-white p-2 md:p-5">
                <div className="md:flex justify-between">
                  <div className="space-y-3">
                    ...
                    <img
                      className="bg-white p-1 md:p-4 rounded-md"
                      src={visa}
                      alt=""
                    />
          ...
          <div className="md:flex-1 p-8">
            ...
            <div className="mt-6 space-y-4">
              {Billing.map((bill) => (
                <div
                  key={bill.id}
                  className="md:flex justify-between bg-[#F1F1F1]  items-center md:p-1 p-4"
                >
                  <img src={pdfpic} alt="" />
